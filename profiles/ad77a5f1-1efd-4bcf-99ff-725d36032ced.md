...
exo__Asset_updatedAt: 2026-08-21T10:55:50
exo__Instance_class:
...
aliases:
  - $profiles
---
> ⛤ Перенесено из README репозитория exoas-profiles (снят 2026-08-16 как негомоиконичный:
> проза ОБ ассетспейсе, живущая ВНЕ графа). Источник — git-история, коммит-родитель 65ec4b22544a94c0a284a9d6c61a81f9000486ab.
